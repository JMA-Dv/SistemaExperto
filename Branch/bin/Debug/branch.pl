...
materia('Conmutación de Redes',semestre7).
materia('Taller de investigacion 2',semestre7).
materia('Gestion de proyectos de software',semestre7).
materia('Programación de base de datos',semestre7).
materia('Programación logica y funcional',semestre7).
materia('Programación web',semestre7).
...
area(administrador_de_base_de_datos,'Programación de base de datos').
